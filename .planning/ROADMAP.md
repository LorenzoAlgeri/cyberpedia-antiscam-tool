...
Plans:
- [ ] 04-01-PLAN.md — Create guards.ts with runtime type guards, harden storage.ts JSON.parse sites, normalize secondary reads
- [ ] 04-02-PLAN.md — Add assertNever exhaustive switch assertions to reducer, processStep, and renderStep
...
| 4. TypeScript Strictness | 0/2 | Not started | - |
